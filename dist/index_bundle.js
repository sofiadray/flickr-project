 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(4);var invariant=__webpack_require__(3);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(9);var _assign=__webpack_require__(2);var emptyFunction$1=__webpack_require__(1);var EventListener=__webpack_require__(10);var getActiveElement=__webpack_require__(11);var shallowEqual=__webpack_require__(12);var containsNode=__webpack_require__(13);var focusNode=__webpack_require__(14);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(23);var camelizeStyleName=__webpack_require__(25);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
exports.ThumbnailRow = exports.Thumbnail = exports.Jumbotron = exports.App = exports.displayThumbnail = undefined;
...
var initialSlides = ['https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?fit=crop&fm=jpg&h=825&q=80&w=1325', 'https://images.unsplash.com/photo-1445251836269-d158eaa028a6?fit=crop&fm=jpg&h=825&q=80&w=1325', 'https://images.unsplash.com/photo-1443926818681-717d074a57af?fit=crop&fm=jpg&h=825&q=80&w=1325', 'https://images.unsplash.com/photo-1445251836269-d158eaa028a6?fit=crop&fm=jpg&h=825&q=80&w=1325'];
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (searchText.length > 0) {
        (0, _flickr.getPhotos)(searchText).then(function (data) {
          _this.setState({
    ...
    }, _this.displayThumbnail = function (idx) {
      _this.setState({
        selected_image: _this.state.slides[idx],
        current_idx: idx
      });
    }, _this.showNextThumbnail = function () {
      if (_this.state.current_idx + 1 === _this.state.slides.length) {
        _this.setState({
          current_idx: 0,
          selected_image: _this.state.slides[0]
        });
      } else {
        var index = _this.state.current_idx + 1;
        _this.setState({
          current_idx: index,
          selected_image: _this.state.slides[index]
        });
      }
    }, _this.showPrevThumbnail = function () {
      if (_this.state.current_idx === 0) {
        var last = _this.state.slides.length - 1;
        _this.setState({
          current_idx: last,
          selected_image: _this.state.slides[last]
        });
      } else {
        var index = _this.state.current_idx - 1;
        _this.setState({
  ...
  _createClass(Jumbotron, [{
    ...
    value: function render() {
      var _props = this.props,
          url = _props.url,
          showNextThumbnail = _props.showNextThumbnail,
          showPrevThumbnail = _props.showPrevThumbnail;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'arrow', style: { float: "left" } },
          _react2.default.createElement('i', { onClick: showPrevThumbnail, className: 'fa fa-angle-left fa-5x', 'aria-hidden': 'true' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'jumbotron-main', style: { height: "500px" } },
          _react2.default.createElement('img', { src: url, style: jumboStyle, alt: 'no results' })
        ),
        _react2.default.createElement(
          'div',
          { className: 'arrow', style: { float: "right" } },
          _react2.default.createElement('i', { onClick: showNextThumbnail, className: 'fa fa-angle-right fa-5x', 'aria-hidden': 'true' })
        )
      );
    }
  }]);
...
Jumbotron.propTypes = {
  ...
  showNextThumbnail: _propTypes2.default.func,
  showPrevThumbnail: _propTypes2.default.func
};

var ThumbnailRow = function (_Component4) {
  _inherits(ThumbnailRow, _Component4);

  function ThumbnailRow() {
    _classCallCheck(this, ThumbnailRow);

    return _possibleConstructorReturn(this, (ThumbnailRow.__proto__ || Object.getPrototypeOf(ThumbnailRow)).apply(this, arguments));
  }

  _createClass(ThumbnailRow, [{
    key: 'render',
    value: function render() {
      var _props2 = this.props,
          thumbnails = _props2.thumbnails,
          displayThumbnail = _props2.displayThumbnail;

      return _react2.default.createElement(
        'div',
        { className: 'thumbnail-row' },
        thumbnails.map(function (el, idx) {
...
ThumbnailRow.propTypes = {
  thumbnails: _propTypes2.default.array,
  displayThumbnail: _propTypes2.default.func
};

var Thumbnail = function (_Component5) {
  _inherits(Thumbnail, _Component5);
  ...
  _createClass(Thumbnail, [{
    ...
    value: function render() {
      var _props3 = this.props,
          idx = _props3.idx,
          url = _props3.url,
          displayThumbnail = _props3.displayThumbnail;
...
var displayThumbnail = exports.displayThumbnail = function displayThumbnail() {};
exports.App = App;
exports.Jumbotron = Jumbotron;
exports.Thumbnail = Thumbnail;
exports.ThumbnailRow = ThumbnailRow;
